...
import { FaTimesCircle, FaImage, FaHashtag, FaGift, FaBullseye, FaCalendarAlt } from 'react-icons/fa';

export default function BrowseRejectedDonationRequest() {
    ...
    const fetchRejectedRequests = async () => {
        try {
            setLoading(true);
            const response = await getDonationRequestsByUserAndStatus("REJECTED");
            console.log("Rejected requests response:", response);
    ...
    if (loading) return <div style={styles.loadingContainer}><p>Loading rejected requests...</p></div>;
        ...
        <div style={styles.container}>
            <div style={styles.header}>
                <h1 style={styles.title}>
                    ...
                    Rejected Donation Requests
                </h1>
                <p style={styles.subtitle}>View all your rejected donation requests</p>
            </div>
            
            {requests.length === 0 ? (
                <div style={styles.emptyContainer}>
                    <p style={styles.emptyText}>No rejected requests found.</p>
                </div>
            ) : (
                        ...
                        <tbody>
                            {requests.map((request) => (
                                ...
                                >
                                    ...
                                    <td style={styles.td}>
                                        <span style={styles.statusBadgeRejected}>
